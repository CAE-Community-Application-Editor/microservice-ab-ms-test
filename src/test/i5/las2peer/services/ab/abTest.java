...
/**
 *
 * ab-ms-test - Test Class
 *
 * This class provides a basic testing framework for the microservice ab-ms-test. It was
...
public class abTest {
  ...
  private static final ServiceNameVersion testTemplateService = new ServiceNameVersion(ab.class.getCanonicalName(),"0.1");
  ...
  public void testa() {
    ...
    try {
      ...
      ClientResponse result = c.sendRequest("GET", mainPath + "//cho", "",
        MediaType.TEXT_PLAIN, MediaType.APPLICATION_JSON, new HashMap<String,String>());
      assertTrue(true); // change here
      System.out.println("Result of 'testa': " + result.getResponse().trim());
    } catch (Exception e) {
      e.printStackTrace();
      fail("Exception: " + e);
    }
